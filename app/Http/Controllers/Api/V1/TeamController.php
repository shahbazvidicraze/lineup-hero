...
class TeamController extends Controller
{
    ...
    public function show(Request $request, Team $team)
    {
        ...
        $team->load(['organization', 'games', 'players' => function ($query) {
            $query->select(['id', 'team_id', 'first_name', 'last_name', 'jersey_number', 'email']) // Select specific columns
                  ->orderBy('last_name')
                  ->orderBy('first_name');
        }]);
    ...
    public function listPlayers_old(Request $request, Team $team)
    {
        ...
        $playersQuery = $team->players()
                        ->select(['id', 'team_id', 'first_name', 'last_name', 'jersey_number', 'email', 'created_at']) // Select desired fields
