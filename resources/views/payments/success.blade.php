    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-header border-0">
                <h5 class="modal-title w-100 text-maroon" id="paymentSuccessModalLabel">Payment Successful</h5>
            </div>
            <div class="modal-body">
                <p class="mb-3">Thank you! Your payment has been processed successfully. 🎉</p>
