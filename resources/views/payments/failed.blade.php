    ...
    <div class="right-panel w-100" style="max-width: 500px;">
        <form id="payment-form">
            ...
            <div class="mb-3">
                ...
                <div id="payment-element" class="form-control d-flex justify-content-center align-items-center  bg-white" style="height: 400px;">
{{--                    <h5>Stripe Form</h5>--}}
                    <img src="{{asset('public/assets/images/stripe_form.png')}}" alt="">
                </div>
            </div>
        ...
        <div class="modal-content text-center">
            <div class="modal-header border-0">
                <div class="d-flex w-100 justify-content-center align-items-center">
                    <div></div>
                    <h5 class="modal-title w-100 text-blue" id="paymentSuccessModalLabel">Payment Failed!</h5>
                    <a href="{{ $type == 'user' ? url('/web/#/main-dashboard-screen') : ($type == 'organization' ? url('/web/#/organization-dashboard-screen') : '#') }}" style="border-radius: 50%; background: #f44336; color: white;font-size:20px;text-decoration-line: none; height:30px; width: 30px;">X</a>
                </div>
            </div>
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    ...
                    <a href="{{ $retryUrl }}" class="btn btn-maroon">Try Again</a>
